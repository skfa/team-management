...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        serialiazer = RecipeSerializer(recipes, many=True)
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        self.assertEqual(res.data, serialiazer.data)
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'link': 'https://exmample.com/new-recipe',
    ...
    def test_updated_user_returns_error(self):
